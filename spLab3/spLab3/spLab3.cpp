...
const UINT ID_SYNC_START = 18;
const UINT ID_SYNC_STOP = 19;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HMENU mainMenu;
	HMENU flow1Menu, flow2Menu, flowInfoMenu, syncMenu;
	...
	AppendMenu(syncMenu, MF_STRING, ID_SYNC_START, L"Включить согласование");
	AppendMenu(syncMenu, MF_STRING, ID_SYNC_STOP, L"Выключить согласование");
	...
	AppendMenu(mainMenu, MF_STRING | MF_POPUP, (UINT)syncMenu, L"Синхронизация");
